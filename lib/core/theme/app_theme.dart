...
class AppTheme {
  ...
  static ThemeData get lightTheme {
    ...
    // The Display Voice
    final headlineTheme = GoogleFonts.manropeTextTheme(baseTheme.textTheme).copyWith(
      ...
      titleLarge: GoogleFonts.manrope(color: AppColors.onSurface, fontWeight: FontWeight.w600),
      titleMedium: GoogleFonts.manrope(color: AppColors.onSurface, fontWeight: FontWeight.w600),
    ...
    final bodyTheme = GoogleFonts.interTextTheme(headlineTheme).copyWith(
      ...
      labelLarge: GoogleFonts.inter(color: AppColors.onSurface, fontWeight: FontWeight.w500, letterSpacing: 0.5),
      labelMedium: GoogleFonts.inter(color: AppColors.onSurface, fontWeight: FontWeight.w500),
      labelSmall: GoogleFonts.inter(color: AppColors.onSurfaceVariant, fontWeight: FontWeight.w500),
    );
    ...
    return ThemeData(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          side: const BorderSide(color: AppColors.outlineVariant, width: 1), // "Ghost Border"
          padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 16),
        ),
      ),
    );
